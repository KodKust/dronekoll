...
export const CountrySchema = z
  .object({
    ...
    // legalStatus pensionerad 2026-09-24 (dronarkartan tools/validate_countries.py
    // fäller fältet) — renderades aldrig, hamnade ur position vid varje radändring.
  })
  .passthrough();
...
export const EnOverlaySchema = z.object({
  meta: z.object({
    ...
    // 'opus-5-5' tillkom 2026-09-23: källförvaltningens 36 länder — ändrade rader
    // översatta och oberoende granskade (dronarkartan 1aac231, LOGG Fas 580).
    engine: z.enum(['deepl', 'manual', 'opus-4-8', 'opus-5', 'opus-5-5', 'gpt-5.6']),
